<?php /* Smarty version 2.6.7, created on 2012-04-07 17:14:27
...
">
				...
				<?php else: ?>
				<img src="http://memeja.com/image/thumb/avatar/<?php if ($this->_tpl_vars['sm']['avatar']):  echo $this->_tpl_vars['sm']['avatar'];  else:  if ($this->_tpl_vars['sm']['gender'] == 'M'): ?>memeja_male.png<?php else: ?>memeja_female.png<?php endif;  endif; ?>"/>
				<?php endif; ?>
