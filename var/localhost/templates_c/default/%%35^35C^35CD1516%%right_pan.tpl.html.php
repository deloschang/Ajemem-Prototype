...
<?php $this->_cache_serials['/opt/lampp/htdocs/flexycms/../var/localhost/templates_c/default/%%35^35C^35CD1516%%right_pan.tpl.html.inc'] = 'f3a2d967bc40be8a197da6750eae8681'; ?>
<!-- Template: user/right_pan.tpl.html Start 24/12/2011 23:05:00 --> 
 <br/>
...
<?php if ($_SESSION['id_user']): ?>
    ...
    <div >
		<br>
		<?php if ($this->caching && !$this->_cache_including) { echo '{nocache:f3a2d967bc40be8a197da6750eae8681#0}';}echo $this->_plugins['function']['get_mod'][0][0]->get_mod(array('mod' => 'user','mgr' => 'user','choice' => 'friend_list','gmod' => 1), $this);if ($this->caching && !$this->_cache_including) { echo '{/nocache:f3a2d967bc40be8a197da6750eae8681#0}';}?>
	...
	<div>
	    <br>
	    <?php if ($this->caching && !$this->_cache_including) { echo '{nocache:f3a2d967bc40be8a197da6750eae8681#1}';}echo $this->_plugins['function']['get_mod'][0][0]->get_mod(array('mod' => 'paypal','mgr' => 'paypal','choice' => 'form'), $this);if ($this->caching && !$this->_cache_including) { echo '{/nocache:f3a2d967bc40be8a197da6750eae8681#1}';}?>
