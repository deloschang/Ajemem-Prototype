...
<?php $this->_cache_serials['/opt/lampp/htdocs/flexycms/../var/localhost/templates_c/default/%%35^35C^35CD1516%%right_pan.tpl.html.inc'] = 'dbdf89d24f1c394158841ff45c844e2a'; ?>
<!-- Template: user/right_pan.tpl.html Start 30/12/2011 00:22:06 --> 
 <br/>
...
<?php if ($_SESSION['id_user']): ?>
    ...
    <div id="my_favorites" >
			<?php if ($this->caching && !$this->_cache_including) { echo '{nocache:dbdf89d24f1c394158841ff45c844e2a#0}';}echo $this->_plugins['function']['get_mod'][0][0]->get_mod(array('mod' => 'manage','mgr' => 'manage','choice' => 'my_favorites','gmod' => 1), $this);if ($this->caching && !$this->_cache_including) { echo '{/nocache:dbdf89d24f1c394158841ff45c844e2a#0}';}?>
