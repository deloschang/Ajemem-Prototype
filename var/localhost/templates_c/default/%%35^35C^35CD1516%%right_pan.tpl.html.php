<?php /* Smarty version 2.6.7, created on 2011-12-20 00:54:59
...
<?php $this->_cache_serials['C:/xampp/htdocs/flexycms/../var/localhost/templates_c/default\%%35^35C^35CD1516%%right_pan.tpl.html.inc'] = '9a7b2710e2fe9bf7bd93cb267052e929'; ?>
<!-- Template: user/right_pan.tpl.html Start 20/12/2011 00:54:59 --> 
 <br/>
...
<?php if ($_SESSION['id_user']): ?>
    ...
    <div >
		<br>
		<?php if ($this->caching && !$this->_cache_including) { echo '{nocache:9a7b2710e2fe9bf7bd93cb267052e929#0}';}echo $this->_plugins['function']['get_mod'][0][0]->get_mod(array('mod' => 'user','mgr' => 'user','choice' => 'friend_list','gmod' => 1), $this);if ($this->caching && !$this->_cache_including) { echo '{/nocache:9a7b2710e2fe9bf7bd93cb267052e929#0}';}?>
	...
	<div>
	    <br>
	    <?php if ($this->caching && !$this->_cache_including) { echo '{nocache:9a7b2710e2fe9bf7bd93cb267052e929#1}';}echo $this->_plugins['function']['get_mod'][0][0]->get_mod(array('mod' => 'paypal','mgr' => 'paypal','choice' => 'form'), $this);if ($this->caching && !$this->_cache_including) { echo '{/nocache:9a7b2710e2fe9bf7bd93cb267052e929#1}';}?>
