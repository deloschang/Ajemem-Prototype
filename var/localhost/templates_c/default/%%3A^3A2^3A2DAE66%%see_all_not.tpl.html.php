<?php /* Smarty version 2.6.7, created on 2012-06-05 01:33:48
...
<!-- Template: manage/see_all_not.tpl.html Start 05/06/2012 01:33:48 --> 
 <?php $this->assign('x', $this->_tpl_vars['util']->get_values_from_config('NOTIFY_TYPE'));  if (count($_from = (array)$this->_tpl_vars['sm']['not'])):
...
Yesterday
<?php else:  echo ((is_array($_tmp=$this->_tpl_vars['k'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%A %e,%Y") : smarty_modifier_date_format($_tmp, "%A %e,%Y")); ?>
...
<?php else:  echo $this->_tpl_vars['x'][$this->_tpl_vars['i1']['notification_type']]; ?>
