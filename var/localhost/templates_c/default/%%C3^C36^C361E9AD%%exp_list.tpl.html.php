<?php /* Smarty version 2.6.7, created on 2012-03-31 09:46:03
...
"/>
		...
		<thead>
		    <th colspan="3" align="center">MOST EXP POINT GAIN</th>
		</thead>
		<thead>
		    <th>Position</th>
		    <th>Username</th>
...
?>
			...
			<tr id="uid<?php echo $this->_tpl_vars['x']['id_user']; ?>
" class="hndptr" lid_user="<?php echo $this->_tpl_vars['x']['id_user']; ?>
...
" >
			    ...
			    <td><?php echo $this->_tpl_vars['x']['exp_point']; ?>
</td>
			</tr>
		    <?php endfor; else: ?>
			<tr>
