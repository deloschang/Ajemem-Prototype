<?php /* Smarty version 2.6.7, created on 2011-12-24 05:01:15
         compiled from user/memeje_friends.tpl.html */ ?>

<!-- Template: user/memeje_friends.tpl.html Start 24/12/2011 05:01:15 --> 
...
" class="pinfo">
					<td width="60" height="60">
						<div class='photo_container'><img src="http://localhost/image/thumb/avatar/<?php if ($this->_tpl_vars['f']['avatar']):  echo $this->_tpl_vars['f']['avatar'];  else:  if ($this->_tpl_vars['f']['gender'] == 'M'): ?>memeje_male.jpg<?php else: ?>memeje_female.jpg<?php endif;  endif; ?>" height="60px" width="60px"/><input type="checkbox" name="sel[]" value="<?php echo $this->_tpl_vars['f']['id_user']; ?>
...
<?php echo '
<script src="http://localhost/templates/flexyjs/filter.js" type="text/javascript" charset="utf-8"></script>
