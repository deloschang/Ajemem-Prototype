...
<!-- Template: user/forgot_pwd.tpl.html Start 17/06/2012 07:51:10 --> 
 
<form action="http:///user/get_forgot_pwd" method="post" name="forgotform" id="forgotform" onsubmit="return validate();">
