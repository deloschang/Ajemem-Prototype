<?php /* Smarty version 2.6.7, created on 2012-01-27 20:29:57
...
<?php $this->_cache_serials['C:/xampp/htdocs/flexycms/../var/localhost/templates_c/default\^%%2C^2C0^2C056D19%%left_pan.tpl.html.inc'] = '2802797a48b8b157b6ebf654d00fddee';  if ($_SESSION['id_user']): ?>
...
<!--    </tr>-->
    <tr>
		...
		<div id="my_meme_list" style="margin-top:-60px;">
			<?php if ($this->caching && !$this->_cache_including) { echo '{nocache:2802797a48b8b157b6ebf654d00fddee#0}';}echo $this->_plugins['function']['get_mod'][0][0]->get_mod(array('mod' => 'manage','mgr' => 'manage','choice' => 'my_meme_list','gmod' => 1), $this);if ($this->caching && !$this->_cache_including) { echo '{/nocache:2802797a48b8b157b6ebf654d00fddee#0}';}?>
	...
	<tr>
		<td>
		<div id="my_favorites" >
			<?php if ($this->caching && !$this->_cache_including) { echo '{nocache:2802797a48b8b157b6ebf654d00fddee#1}';}echo $this->_plugins['function']['get_mod'][0][0]->get_mod(array('mod' => 'manage','mgr' => 'manage','choice' => 'my_favorites','gmod' => 1), $this);if ($this->caching && !$this->_cache_including) { echo '{/nocache:2802797a48b8b157b6ebf654d00fddee#1}';}?>
