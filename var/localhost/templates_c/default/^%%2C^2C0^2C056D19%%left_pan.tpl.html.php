...
<?php $this->_cache_serials['/opt/lampp/htdocs/flexycms/../var/localhost/templates_c/default/^%%2C^2C0^2C056D19%%left_pan.tpl.html.inc'] = 'bad5bd2dc2672d6b93cdc583e416d4a4';  if ($_SESSION['id_user']): ?>
...
<span id="left_pan_level"> L<?php echo $_SESSION['level']; ?>
 ...
 XP)<?php endif; ?></span></b>
    ...
    <tr>
		<td>
		<div id="my_meme_list" >
			<?php if ($this->caching && !$this->_cache_including) { echo '{nocache:bad5bd2dc2672d6b93cdc583e416d4a4#0}';}echo $this->_plugins['function']['get_mod'][0][0]->get_mod(array('mod' => 'manage','mgr' => 'manage','choice' => 'my_meme_list','gmod' => 1), $this);if ($this->caching && !$this->_cache_including) { echo '{/nocache:bad5bd2dc2672d6b93cdc583e416d4a4#0}';}?>
	...
	<tr>
		<td>
		<div id="my_favorites" >
			<?php if ($this->caching && !$this->_cache_including) { echo '{nocache:bad5bd2dc2672d6b93cdc583e416d4a4#1}';}echo $this->_plugins['function']['get_mod'][0][0]->get_mod(array('mod' => 'manage','mgr' => 'manage','choice' => 'my_favorites','gmod' => 1), $this);if ($this->caching && !$this->_cache_including) { echo '{/nocache:bad5bd2dc2672d6b93cdc583e416d4a4#1}';}?>
