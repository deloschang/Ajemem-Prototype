...
<link rel="stylesheet" type="text/css" href="http://129.170.94.179/templates/css_theme/css/<?php echo $this->_tpl_vars['css']['css']; ?>
.css" />
<!--[if lte IE 7.0]><link rel="stylesheet" type="text/css" href="http://129.170.94.179/templates/css_theme/ie.css" media="screen, projection, tv" /><![endif]-->
<!--[if IE 8.0]>
    <?php echo '
    <style type="text/css">
...
<![endif]-->
<script type="text/javascript" src="http://129.170.94.179/libsext/jquery/jquery.js"></script>
<script type="text/javascript" src="http://129.170.94.179/libsext/js/jquery.validate.js"></script>
<script type="text/javascript" src="http://129.170.94.179/libsext/fancybox/jquery.fancybox-1.3.2.pack.js"></script>
<script type="text/javascript" src="http://129.170.94.179/templates/flexyjs/flexymessage.js"></script>

<script type="text/javascript" src="http://129.170.94.179/libsext/fckeditor/fckeditor.js"></script>
<!--<script type="text/javascript" src="http://129.170.94.179/templates/flexyjs/js/jquery.multiautocomplete.js"></script>-->
<script type="text/javascript" src="http://129.170.94.179/libsext/js/jquery.autocomplete.js"></script>
<script type="text/javascript" src="http://129.170.94.179/libsext/js/overlib.js"></script>
<script type="text/javascript" src="http://129.170.94.179/libsext/js/ajaxfileupload.js"></script>
<script type="text/javascript" src="http://129.170.94.179/libsext/jquery/jquery-ui.js"></script>

<link rel="stylesheet" type="text/css" href="http://129.170.94.179/templates/css_theme/jquery-ui-1.7.3.css"/>
<link rel="stylesheet" type="text/css" href="http://129.170.94.179/templates/css_theme/fancybox/jquery.fancybox-1.3.2.css"/>
          ...
          <div id="userbox">
                    <div class="inner">
                        <strong><?php echo $_SESSION['username']; ?>
                            ...
                            <ul class="clearfix">
                                <li><a href="http://129.170.94.179/flexyadmin/user/profile">Modify Profile</a></li>
                            </ul>
                    </div>
<!-- <a id="logout" title="Logout" href="http://129.170.94.179/page-user-choice-logout-a-1">log out<span class="ir"></span></a>-->
                    <a id="logout" title="Logout" href="http://129.170.94.179/user/logout/a/1">log out<span class="ir"></span></a>           
		  </div>
          </div>
        </div>
    </div>
