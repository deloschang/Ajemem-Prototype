<?php /* Smarty version 2.6.7, created on 2011-12-22 03:12:55
...
<?php $this->_cache_serials['/opt/lampp/htdocs/flexycms/../var/localhost/templates_c/default/^%%35^35C^35CD1516%%right_pan.tpl.html.inc'] = 'd1d1e1b728a9c3ad6e25c45861045a5f'; ?>
<!-- Template: user/right_pan.tpl.html Start 22/12/2011 03:12:55 --> 
 <br/>
...
<?php if ($_SESSION['id_user']): ?>
    ...
    <div >
		<br>
		<?php if ($this->caching && !$this->_cache_including) { echo '{nocache:d1d1e1b728a9c3ad6e25c45861045a5f#0}';}echo $this->_plugins['function']['get_mod'][0][0]->get_mod(array('mod' => 'user','mgr' => 'user','choice' => 'friend_list','gmod' => 1), $this);if ($this->caching && !$this->_cache_including) { echo '{/nocache:d1d1e1b728a9c3ad6e25c45861045a5f#0}';}?>
	...
	<div>
	    <br>
	    <?php if ($this->caching && !$this->_cache_including) { echo '{nocache:d1d1e1b728a9c3ad6e25c45861045a5f#1}';}echo $this->_plugins['function']['get_mod'][0][0]->get_mod(array('mod' => 'paypal','mgr' => 'paypal','choice' => 'form'), $this);if ($this->caching && !$this->_cache_including) { echo '{/nocache:d1d1e1b728a9c3ad6e25c45861045a5f#1}';}?>
