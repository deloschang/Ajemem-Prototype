...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'capitalize', 'common/common.tpl.html', 261, false),array('function', 'get_mod', 'common/common.tpl.html', 339, false),)), $this); ?>
<?php $this->_cache_serials['/Applications/XAMPP/xamppfiles/htdocs/flexycms/../var/localhost/templates_c/default/^%%4F^4F7^4F7F9384%%common.tpl.html.inc'] = 'a581f5e421de335477041baa28a537d1'; ?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
unset($_smarty_tpl_vars);
  echo '';  if (! $_SESSION['id_user']):  echo '<!-- NLU looks @ home page -->';  if (! $_SESSION['profile']):  echo '<div id="front_message">';  $_smarty_tpl_vars = $this->_tpl_vars;
...
if ($this->_foreach['cur_meme']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['k'] => $this->_tpl_vars['x']):
        $this->_foreach['cur_meme']['iteration']++;
 echo '<span><img src="https://graph.facebook.com/';  echo $this->_tpl_vars['x']['id'];  echo '/picture"/>';  echo $this->_tpl_vars['x']['name'];  echo '</span>';  endforeach; endif; unset($_from);  echo '</span>';  endif;  echo '';  else:  echo '<!--Need to move to appropriate styling--><div id="my_meme_container"><div id="my_meme_list">';  if ($this->caching && !$this->_cache_including) { echo '{nocache:a581f5e421de335477041baa28a537d1#0}';}echo $this->_plugins['function']['get_mod'][0][0]->get_mod(array('mod' => 'manage','mgr' => 'manage','choice' => 'my_meme_list','gmod' => 1), $this);if ($this->caching && !$this->_cache_including) { echo '{/nocache:a581f5e421de335477041baa28a537d1#0}';} echo '</div><div id="my_meme_tagged" style="display:none;">';  if ($this->caching && !$this->_cache_including) { echo '{nocache:a581f5e421de335477041baa28a537d1#1}';}echo $this->_plugins['function']['get_mod'][0][0]->get_mod(array('mod' => 'manage','mgr' => 'manage','choice' => 'tagged_memes','gmod' => 1), $this);if ($this->caching && !$this->_cache_including) { echo '{/nocache:a581f5e421de335477041baa28a537d1#1}';} echo '</div><div id="my_meme_liked" style="display:none;">';  if ($this->caching && !$this->_cache_including) { echo '{nocache:a581f5e421de335477041baa28a537d1#2}';}echo $this->_plugins['function']['get_mod'][0][0]->get_mod(array('mod' => 'manage','mgr' => 'manage','choice' => 'my_favorites','gmod' => 1), $this);if ($this->caching && !$this->_cache_including) { echo '{/nocache:a581f5e421de335477041baa28a537d1#2}';} echo '</div></div>';  endif;  echo '</div></div><div id="login_top"><div class="fb-login-button" size="large" scope="email,publish_stream,user_education_history';  echo '';  echo '">Share Experiences Now</div></div></div>';  endif;  echo '';  else:  echo '<div id="top_header" class="nohighlight"><div id="header_cont"><div id="header_box"><div id="user_menu"><div id="user_pic" class="nohighlight"><a href="/?id=';  echo $_SESSION['dupe_username'];  echo '">';  if ($_SESSION['fb_pic_normal']):  echo '<img src="';  echo $_SESSION['fb_pic_normal'];  echo '" style="width:25px;height:25px">';  else:  echo '<img src="http://localhost/image/thumb/avatar/';  if ($_SESSION['avatar']):  echo '';  echo $_SESSION['avatar'];  echo '';  else:  echo '';  if ($_SESSION['gender'] == 'M'):  echo 'memeja_male.png';  else:  echo 'memeja_female.png';  endif;  echo '';  endif;  echo '" style="width:25px;height:25px"/>';  endif;  echo '</a></div><div id="rank_circle"><div id="ranking_number">';  if ($_SESSION['exp_rank']):  echo '<a href="/?id=';  echo $_SESSION['dupe_username'];  echo '">';  echo $_SESSION['exp_rank'];  echo '</a>';  else:  echo '?';  endif;  echo '</div></div><div id = "user_name" class="nohighlight"><a href ="/?id=';  echo $_SESSION['dupe_username'];  echo '">';  echo ((is_array($_tmp=$_SESSION['fname'])) ? $this->_run_mod_handler('capitalize', true, $_tmp) : smarty_modifier_capitalize($_tmp));  echo '</a></div><div class="nav_menu" id="hover_menu"><div class="hover_menu_contents"><ul class="nav_menu_list"><!--<li><a href="/?id=';  echo $_SESSION['dupe_username'];  echo '">My Profile</a></li>--><li><a href="javascript:void(0);" onclick="fb_logout();">Logout</a></li></ul></div></div><div id="triangle_down"></div></div></div><form id ="searches"><input type="text" class="self-describing" name="mtitle" id="mtitle" title="Search by title." style="width:300px;"/></form><div id="header_nav"><table><tr><td><div id="home_link" class="header_nav"><a href="/">Home</a></div></td><td><div id="random_meme" class="header_nav"><a href="javascript:void(0);" onclick="get_random_meme();">Random</a></div></td><td><div id="feedback" class="header_nav"><a href="javascript:void(0);" onclick="javascript:toggleDiv(\'content1\',\'icon1\');">Feedback?</a><div id="content1" class="item" style="display:none; z-index:500;"><form action="send-contact-message.php" method="post"><p><input type="hidden" name="name" id="name" size="25" value="';  echo $_SESSION['username'];  echo '"></p><p>Comments:<br><textarea name="message" rows="5" cols="25"></textarea></p><p><button type="submit">Submit</button></p></form></div></div></td></tr></table></div><div id="callToAction"><a href="javascript:void(0);" class="large orangellow button">Create</a><div class="create_menu" id="hover_menu"><div class="create_menu_contents"><ul class="create_menu_list"><li><a href="/macromeme.html" onclick="fb_logout();">Simple</a></li><li><a href="/meme/addMeme" onclick="fb_logout();">Meaningful</a></li></ul></div></div></div><div id= "logoc" class="nohighlight"><a href="http://localhost/"><img src="http://localhost/templates/images/memeja_logo.gif" id="logo"></a></div><!--';  if ($_REQUEST['choice'] != 'addMeme'):  echo '<div id="xpbar_info" class="nohighlight"><div id="xpbar"></div><div id="user_level"></div><div id="xpbar_status"></div></div>';  endif;  echo '--></div></div>';  if ($_REQUEST['choice'] == 'macromeme'):  echo '<div id="flashContent"><p>To view this page ensure that Adobe Flash Player version11.2.0 or greater is installed.</p><script type="text/javascript">var pageHost = ((document.location.protocol == "https:") ? "https://" : "http://");document.write("<a href=\'http://www.adobe.com/go/getflashplayer\'><img src=\'"+ pageHost + "www.adobe.com/images/shared/download_buttons/get_flash_player.gif\' alt=\'Get Adobe Flash player\' /></a>" );</script></div>';  endif;  echo '';  if ($_REQUEST['choice'] != 'addMeme' && $_REQUEST['choice'] != 'macromeme'):  echo '<div id="contained">';  if (! $_SESSION['profile']):  echo '<!-- view home page --><div id="live_feed" class="nohighlight">';  $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "meme/home.tpl.html", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
  echo '</div>';  elseif ($_SESSION['profile'] == 'invalid'):  echo '<div id="profile_page"><div id="profile_name"><center>Flerp? We couldn\'t find this user!</center></div></div>';  else:  echo '<div id="profile_page"><div id="left_info"><div id="profile_pic">';  if ($_SESSION['profile_picture']):  echo '<img src="';  echo $_SESSION['profile_picture'];  echo '"class="profile_pic"/>';  else:  echo '<img src="http://localhost/image/thumb/avatar/';  if ($_SESSION['avatar']):  echo '';  echo $_SESSION['avatar'];  echo '';  else:  echo '';  if ($_SESSION['gender'] == 'M'):  echo 'memeja_male.png';  else:  echo 'memeja_female.png';  endif;  echo '';  endif;  echo '"class="profile_pic"/>';  endif;  echo '</div><div id="user_info"><div id="profile_name"><a href="/?id=';  echo $_SESSION['profile_dupe_username'];  echo '">';  echo ((is_array($_tmp=$_SESSION['profile'])) ? $this->_run_mod_handler('capitalize', true, $_tmp) : smarty_modifier_capitalize($_tmp));  echo '</a></div><div id="profile_follow_cont"><div id="follower_count">';  if (! $_SESSION['profile_follower_count'] == '0'):  echo '';  echo $_SESSION['profile_follower_count'];  echo '';  else:  echo '0';  endif;  echo '&nbsp followers</div>';  if ($_SESSION['following'] == 'y'):  echo '<span id="follow_me"><a href="javascript:void(0);" id="follow_btn" class="large orangellow button" onclick="follow_user(\'unfollow\');">Follow &nbsp --</a></span>';  elseif ($_SESSION['following'] == 'n'):  echo '<span id="follow_me"><a href="javascript:void(0);" id="follow_btn"class="large orangellow button" onclick="follow_user(\'follow\');">Follow &nbsp ++</a></span>';  endif;  echo '</div><div id="my_memes"><a id="created" class="a-btn"href="javascript:void(0);" onclick="switch_list(\'created\');"><span></span><span>Created</span><span>My Works!</span></a><a id="likes" class="a-btn"href="javascript:void(0);" onclick="switch_list(\'likes\');"><span></span><span>Liked</span><span>My Favs!</span></a><a id="tagged" class="a-btn" href="javascript:void(0);" onclick="switch_list(\'tagged\');"><span></span><span>Tagged</span><span>About Me!</span></a></div></div></div><!--Need to move to appropriate styling--><div id="my_meme_container" style="position:absolute;top:0;left:20%;"><div id="my_meme_list">';  if ($this->caching && !$this->_cache_including) { echo '{nocache:a581f5e421de335477041baa28a537d1#3}';}echo $this->_plugins['function']['get_mod'][0][0]->get_mod(array('mod' => 'manage','mgr' => 'manage','choice' => 'my_meme_list','gmod' => 1), $this);if ($this->caching && !$this->_cache_including) { echo '{/nocache:a581f5e421de335477041baa28a537d1#3}';} echo '</div><div id="my_meme_tagged" style="display:none;">';  if ($this->caching && !$this->_cache_including) { echo '{nocache:a581f5e421de335477041baa28a537d1#4}';}echo $this->_plugins['function']['get_mod'][0][0]->get_mod(array('mod' => 'manage','mgr' => 'manage','choice' => 'tagged_memes','gmod' => 1), $this);if ($this->caching && !$this->_cache_including) { echo '{/nocache:a581f5e421de335477041baa28a537d1#4}';} echo '</div><div id="my_meme_liked" style="display:none;">';  if ($this->caching && !$this->_cache_including) { echo '{nocache:a581f5e421de335477041baa28a537d1#5}';}echo $this->_plugins['function']['get_mod'][0][0]->get_mod(array('mod' => 'manage','mgr' => 'manage','choice' => 'my_favorites','gmod' => 1), $this);if ($this->caching && !$this->_cache_including) { echo '{/nocache:a581f5e421de335477041baa28a537d1#5}';} echo '</div></div><div id="view_meme">';  if ($_SESSION['profile_meme_image']):  echo '<div id="profile_meme">';  echo $_SESSION['profile_meme_title'];  echo '</div><div id="profile_meme_image"><a class="meme_gallery" data-fancybox-group="my_meme" id="selected_image" href="http://localhost/image/orig/meme/';  echo $_SESSION['profile_meme_image'];  echo '" title="';  echo $_SESSION['profile_meme_title'];  echo '"><img src="http://localhost/image/orig/meme/';  echo $_SESSION['profile_meme_image'];  echo '" style="display:none;"/></a></div><div id="current_description" style="display: none;"><div>';  if ($_SESSION['profile_meme_tagged']):  echo '<span class="fancybox_tagged">Tagged:';  $this->_foreach['cur_meme'] = array('total' => count($_from = (array)$_SESSION['profile_meme_tagged']), 'iteration' => 0);
if ($this->_foreach['cur_meme']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['k'] => $this->_tpl_vars['x']):
        $this->_foreach['cur_meme']['iteration']++;
 echo '<span><img src="https://graph.facebook.com/';  echo $this->_tpl_vars['x']['id'];  echo '/picture"/>';  echo $this->_tpl_vars['x']['name'];  echo '</span>';  endforeach; endif; unset($_from);  echo '</span>';  endif;  echo '<div class="fb-comments" id="inner" data-href=\'http://memeja.com/?id=';  echo $_SESSION['profile_dupe_username'];  echo '&meme=';  echo $_SESSION['profile_meme_id'];  echo '\' data-num-posts="10" data-width="400"></div></div></div>';  if ($_SESSION['profile_meme_tagged']):  echo '<span id="profile_tagged">Tagged:';  $this->_foreach['cur_meme'] = array('total' => count($_from = (array)$_SESSION['profile_meme_tagged']), 'iteration' => 0);
if ($this->_foreach['cur_meme']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['k'] => $this->_tpl_vars['x']):
        $this->_foreach['cur_meme']['iteration']++;
 echo '<span><img src="https://graph.facebook.com/';  echo $this->_tpl_vars['x']['id'];  echo '/picture"/>';  echo $this->_tpl_vars['x']['name'];  echo '</span>';  endforeach; endif; unset($_from);  echo '</span>';  endif;  echo '';  endif;  echo '</div></div>';  endif;  echo '';  else:  echo '<div id="editorcontent" class="nohighlight">';  $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => $this->_tpl_vars['content'], 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
