<?php /* Smarty version 2.6.7, created on 2012-06-11 21:27:21
...
<?php $this->_cache_serials['C:/xampp/htdocs/flexycms/../var/localhost/templates_c/default\^%%4F^4F7^4F7F9384%%common.tpl.html.inc'] = 'f53ca9230fcc8fe8cbede2f86fb8bd06'; ?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
/picture"/>
		...
		<div id="my_meme_list">
			<?php if ($this->caching && !$this->_cache_including) { echo '{nocache:f53ca9230fcc8fe8cbede2f86fb8bd06#0}';}echo $this->_plugins['function']['get_mod'][0][0]->get_mod(array('mod' => 'manage','mgr' => 'manage','choice' => 'my_meme_list','gmod' => 1), $this);if ($this->caching && !$this->_cache_including) { echo '{/nocache:f53ca9230fcc8fe8cbede2f86fb8bd06#0}';}?>

		</div>
		<div id="my_tagged">
			<?php if ($this->caching && !$this->_cache_including) { echo '{nocache:f53ca9230fcc8fe8cbede2f86fb8bd06#1}';}echo $this->_plugins['function']['get_mod'][0][0]->get_mod(array('mod' => 'manage','mgr' => 'manage','choice' => 'tagged_memes','gmod' => 1), $this);if ($this->caching && !$this->_cache_including) { echo '{/nocache:f53ca9230fcc8fe8cbede2f86fb8bd06#1}';}?>
...
"class="profile_pic"/>
			...
			<?php endif; ?>
				...
				<div id="my_meme_list" style="margin-top:-60px;">
					<?php if ($this->caching && !$this->_cache_including) { echo '{nocache:f53ca9230fcc8fe8cbede2f86fb8bd06#2}';}echo $this->_plugins['function']['get_mod'][0][0]->get_mod(array('mod' => 'manage','mgr' => 'manage','choice' => 'my_meme_list','gmod' => 1), $this);if ($this->caching && !$this->_cache_including) { echo '{/nocache:f53ca9230fcc8fe8cbede2f86fb8bd06#2}';}?>

				</div>
				<div id="my_tagged">
					<?php if ($this->caching && !$this->_cache_including) { echo '{nocache:f53ca9230fcc8fe8cbede2f86fb8bd06#3}';}echo $this->_plugins['function']['get_mod'][0][0]->get_mod(array('mod' => 'manage','mgr' => 'manage','choice' => 'tagged_memes','gmod' => 1), $this);if ($this->caching && !$this->_cache_including) { echo '{/nocache:f53ca9230fcc8fe8cbede2f86fb8bd06#3}';}?>

				</div>
				<div id="my_favorites" >
					<?php if ($this->caching && !$this->_cache_including) { echo '{nocache:f53ca9230fcc8fe8cbede2f86fb8bd06#4}';}echo $this->_plugins['function']['get_mod'][0][0]->get_mod(array('mod' => 'manage','mgr' => 'manage','choice' => 'my_favorites','gmod' => 1), $this);if ($this->caching && !$this->_cache_including) { echo '{/nocache:f53ca9230fcc8fe8cbede2f86fb8bd06#4}';}?>
...
"class="profile_pic"/>
			...
			<div id="my_meme_list" style="margin-top:-60px;">
				<?php if ($this->caching && !$this->_cache_including) { echo '{nocache:f53ca9230fcc8fe8cbede2f86fb8bd06#5}';}echo $this->_plugins['function']['get_mod'][0][0]->get_mod(array('mod' => 'manage','mgr' => 'manage','choice' => 'my_meme_list','gmod' => 1), $this);if ($this->caching && !$this->_cache_including) { echo '{/nocache:f53ca9230fcc8fe8cbede2f86fb8bd06#5}';}?>
			...
			<div id="my_favorites" >
				<?php if ($this->caching && !$this->_cache_including) { echo '{nocache:f53ca9230fcc8fe8cbede2f86fb8bd06#6}';}echo $this->_plugins['function']['get_mod'][0][0]->get_mod(array('mod' => 'manage','mgr' => 'manage','choice' => 'my_favorites','gmod' => 1), $this);if ($this->caching && !$this->_cache_including) { echo '{/nocache:f53ca9230fcc8fe8cbede2f86fb8bd06#6}';}?>
...
/picture"/>
			...
			<div id="my_meme_list">
				<?php if ($this->caching && !$this->_cache_including) { echo '{nocache:f53ca9230fcc8fe8cbede2f86fb8bd06#7}';}echo $this->_plugins['function']['get_mod'][0][0]->get_mod(array('mod' => 'manage','mgr' => 'manage','choice' => 'my_meme_list','gmod' => 1), $this);if ($this->caching && !$this->_cache_including) { echo '{/nocache:f53ca9230fcc8fe8cbede2f86fb8bd06#7}';}?>

			</div>
			
			<div id="my_tagged">
				<?php if ($this->caching && !$this->_cache_including) { echo '{nocache:f53ca9230fcc8fe8cbede2f86fb8bd06#8}';}echo $this->_plugins['function']['get_mod'][0][0]->get_mod(array('mod' => 'manage','mgr' => 'manage','choice' => 'tagged_memes','gmod' => 1), $this);if ($this->caching && !$this->_cache_including) { echo '{/nocache:f53ca9230fcc8fe8cbede2f86fb8bd06#8}';}?>
