<?php /* Smarty version 2.6.7, created on 2012-04-07 17:10:07
         compiled from meme/respective_replies.tpl.html */ ?>

<!-- Template: meme/respective_replies.tpl.html Start 07/04/2012 17:10:07 --> 
...
<img src="http://memeja.com/image/thumb/avatar/<?php echo $this->_tpl_vars['sm']['uinfo'][$this->_tpl_vars['i']['id_user']]['avatar']; ?>
" style="width:50px;height:50px"/>
<?php else: ?>
<img src="http://memeja.com/image/thumb/avatar/<?php if ($_SESSION['gender'] == 'M'): ?>memeja_male.png<?php else: ?>memeja_female.png" style="width:50px;height:50px"/><?php endif; ?>
<?php endif; ?></a>
...
');" style="cursor: pointer;"><img src="http://memeja.com/templates/images/reply.gif "style="width:15px;height:15px"/><span style="font-size:13px;">Reply</span></a>
