<?php /* Smarty version 2.6.7, created on 2012-04-06 19:27:23
...
<!-- Template: user/register.tpl.html Start 06/04/2012 19:27:23 --> 
 <?php echo '
...
<form id="signupform" name="signupform" action="http://memeja.com/user/<?php if ($this->_tpl_vars['sm']['flag']): ?>update_profile<?php else: ?>insert<?php endif; ?>" method="post" onSubmit="return checkvalidate();">
    <table align="center" class="form_tbl">
        <tr>
            <th colspan="2"><?php if (! $this->_tpl_vars['sm']['res']['username']): ?>You're Almost There!<?php else: ?>Edit Profile &nbsp;&nbsp;&nbsp;&nbsp;<a href="http://memeja.com/user/change_password">Change Password</a><?php endif; ?></th>
        </tr> 
        <tr>
...
<br />
		...
		<tr>
			<td align="right"><a href="http://memeja.com/templates/default/user/termsandconditions.html" target="_blank">Terms and Conditions</a>
