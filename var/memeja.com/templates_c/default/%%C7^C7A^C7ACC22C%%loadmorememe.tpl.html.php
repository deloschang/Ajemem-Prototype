<?php /* Smarty version 2.6.7, created on 2012-04-07 17:13:11
...
<!-- Template: meme/loadmorememe.tpl.html Start 07/04/2012 17:13:11 --> 
...
<script type="text/javascript">	
	...
	function live_meme () {
		...
		var live_meme_data;
		var url="http://memeja.com/meme/live_meme/";
	...
	function live_feed (i) {		
		...
		var url="http://memeja.com/meme/live_feed/";
...
" class="avatar_thumb_regular"/>
				...
				<?php if ($_SESSION['gender'] == 'M'): ?>
					<img src="http://memeja.com/image/thumb/avatar/memeja_male.png" class="avatar_thumb_regular"/>
				<?php else: ?>
					<img src="http://memeja.com/image/thumb/avatar/memeja_female.png" class="avatar_thumb_regular"/>
				<?php endif; ?>
				<?php endif; ?>			
			</span>
...
');"><span style="font-size:15px;">Dishonor</span></a>
				...
				<?php if ($this->_tpl_vars['x']['tot_honour'] > 1): ?>
					<img src="http://memeja.com/image/orig/premade_images/EWBTE.png" title="Good job! The 2nd Honor!" style="width:17px; height:17px"/>
				<?php endif; ?>
				<?php if ($this->_tpl_vars['x']['tot_honour'] > 2): ?>
					<img src="http://memeja.com/image/orig/premade_images/ExcitedTroll.png" title="Excited Troll is excited! 2 Honors!" style="width:17px; height:17px"/>
				<?php endif; ?>
				<?php if ($this->_tpl_vars['x']['tot_honour'] > 3): ?>
					<img src="http://memeja.com/image/orig/premade_images/LOL.png" title="L0L! 3 Honors!" style="width:17px; height:17px"/>
				<?php endif; ?>
				<?php if ($this->_tpl_vars['x']['tot_honour'] > 4): ?>
					<img src="http://memeja.com/image/orig/premade_images/Obama Not Bad.png" title="Obama says this meme is NOT BAD!" style="width:17px; height:17px"/>
				<?php endif; ?>
				</span>
