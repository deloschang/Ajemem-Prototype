<<<<<<< HEAD
<?php /* Smarty version 2.6.7, created on 2011-10-15 16:53:39
...
<div style="width:640px;;height:auto;">
    ...
    <div >
	<img src="http://www.memeja.com/image/orig/<?php if ($this->_tpl_vars['sm']['fg'] == 1): ?>duel<?php else: ?>meme<?php endif; ?>/<?php echo $this->_tpl_vars['sm']['det_meme']['image']; ?>
" title="Meme" />
    </div>
    <div>
