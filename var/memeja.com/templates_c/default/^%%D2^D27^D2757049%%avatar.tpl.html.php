...
<!-- Template: user/avatar.tpl.html Start 07/04/2012 17:13:12 --> 
...
" style="width:200px;height:auto; padding-top:5px;">
	<?php else: ?>
    <img src="http://memeja.com/image/thumb/avatar/<?php if ($_SESSION['avatar']):  echo $_SESSION['avatar'];  else:  if ($_SESSION['gender'] == 'M'): ?>memeja_male.png<?php else: ?>memeja_female.png<?php endif;  endif; ?>" style="width:140px;height:auto;"/>
    <?php endif; ?>
